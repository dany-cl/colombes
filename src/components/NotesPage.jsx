...
import EntreeNotes from './EntreeNotes';
...
export default function NotesPage() {
  ...
  function renderDetails() {
    ...
    const paged = sorted.slice(start + 0, start + pageSize);
      ...
      <div className="details-card">
        ...
        <div className="details-body">
          <table className="details-table">
            <thead>
              {/* ... tes en-têtes de colonnes ... */}
            </thead>
            <tbody>
              {/* ... tes lignes de données ... */}
            </tbody>
          </table>
  ...
  return (
    <div className="dashboard-root">
      ...
      <main className="dashboard-main">
        ...
        {activeSection === "entree" && (
          <EntreeNotes onBasculerVersStats={() => setActiveSection("stats")} />
        )}
        {activeSection === "stats" && (
          <StatsNotes onRetour={() => setActiveSection("entree")} />
        )}
